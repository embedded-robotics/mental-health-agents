...
Considering the user input and the past history, your job is to adopt the practices used in {therapy_technique} and provide mental health support to this person such that it improves the
overall mental health of the person by alleviating the feelings of depression, sadness, or hopelessness from the person's mind
...
system_summarize_prompt = "You are a mental health expert who specializes in summarizing and synthesizing counselling advice provided by various mental health counsellors"
user_summarize_prompt = '''You are given a user input shared by a mentally ill person along with the past history of the same person categorized by social determinants.
Moreover, you are given several counselling advices provided by mental health counsellors to this person to alleviate feelings of depression, sadness, or hopelessness from this person's mind and improve the overall mental health state of this person.
Your job is to summarize the information from all the counselling advices and synthesize it into a comprehensive response which addresses all the points mentioned in different counselling advices. Moreover, your summarized
response should be personalized by using using the user input and the past history of the user.
